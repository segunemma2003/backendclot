...
const ShoppingCart = () => {
  ...
  return (
    <div>
      {/* ===== Head Section ===== */}
      <Header title={`Shopping Cart - Henrimars Fashion`} />
                  ...
                  cart.map((item) => {
                    ...
                    return (
                      <tr className="border-b-2 border-gray200" key={item.id}>
                        ...
                        ₦ {roundDecimal(item.price).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                        </td>
                        <td>
                        ...
                        ₦ {roundDecimal(item.price * item.quantity!).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                          <br />
          ...
          <div className="h-full w-full lg:w-4/12 mt-10 lg:mt-0">
            ...
            <div className="border border-gray500 divide-y-2 divide-gray200 p-6">
              ...
              <div className="flex justify-between py-2">
                ...
                <span>₦ {roundDecimal(subtotal).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}</span>
              </div>
              <div className="py-3">
              ...
              <div className="flex justify-between py-3">
                ...
                <span>₦ {roundDecimal(subtotal + deliFee).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}</span>
              </div>
              <Button
