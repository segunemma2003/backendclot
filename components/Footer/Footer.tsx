    ...
    <>
      ...
      <div className={styles.bottomFooter}>
        <div className="app-max-width app-x-padding w-full flex justify-between">
          <span className="">@2022 Henrimars. {t("all_rights_reserved")}</span>
          <span className="flex items-center">
            ...
            <a
              ...
              aria-label="Facebook Page for Henrimaris Fashion"
            >
              <FacebookLogo />
            </a>
            <a
              href="www.ig.com"
              aria-label="Instagram Account for Henrimaris Fashion"
            >
              <InstagramLogo />
            </a>
          </span>
